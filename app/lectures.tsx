    ...
    return (
        <View className="flex-1 bg-[#0061FF]">
            ...
            <View className="px-6 pt-12 pb-6 flex-row items-center justify-between">
                ...
                <Text className="text-xl font-nunito-extrabold text-white">Lectures</Text>
                <View className="w-10" />
            </View>
            ...
            <View className="flex-1 bg-white rounded-t-[40px] shadow-2xl overflow-hidden">
                    ...
                    >
                        {SUBJECTS.map((subject) => (
                            <TouchableOpacity
                                ...
                                className={`px-6 py-2.5 rounded-full mr-3 border border-gray-100 shadow-sm ${selectedSubject === subject ? 'bg-[#0061FF]' : 'bg-white'}`}
                            >
                ...
                <ScrollView className="flex-1 px-6" showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 40, paddingTop: 10 }}>
