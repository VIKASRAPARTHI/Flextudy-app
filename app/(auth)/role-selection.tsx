    ...
    return (
        <SafeAreaView className="flex-1 bg-white px-6 py-6 justify-between">
            <View className="items-center w-full flex-1 justify-center pt-16">
                ...
                {/* Join As Section */}
                <Text className="text-lg font-bold text-gray-900 mb-6 self-start w-full text-center mt-12">Join As</Text>
                ...
                <View className="flex-row w-full justify-between gap-4 mb-4">
                    ...
                    >
                        <Text className="text-gray-900 font-bold text-lg">Teacher</Text>
                    </TouchableOpacity>
                </View>
            </View>
